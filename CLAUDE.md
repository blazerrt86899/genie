...
│       │   ├── file_service.py        ← file_creator: Markdown→blocks parser, render() — real docx headings/tables/bold via python-docx, real pdf headings/tables/bold via fpdf2 write_html, xlsx via openpyxl — + S3 upload/download
│       │   └── rag/
